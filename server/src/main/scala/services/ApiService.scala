...
class ApiService extends Api {
  override def getItems(limit: Int): Array[Event] = {
    Array(
      ...
      Event(2, "Spark: Wprowadzenie - Poland CodiLime Tech Talk (Warsaw) - Meetup", 1445672700000L, 1445672700000L+3600000*26, "Wydział MIMUW, Banacha 2, Warsaw", "http://www.meetup.com/Poland-CodiLime-Tech-Talk/events/226054818/"),
